...
<div class="h-dvh flex flex-col darkxpbg">
	...
	<div class="text-center text-gray-100 text-sm text-shadow-lg h-[31px] inline-flex flex-row justify-center z-0 gap-2 mb-1">
		<span class="h-full">
...
<style>
	...
	.hoverfont :hover{
		animation: hoverfont 1s infinite step-end;
	}
